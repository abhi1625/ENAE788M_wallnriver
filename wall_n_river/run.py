...
moduleNetwork = Network().eval()#cuda().eval()
...
def estimate(tensorFirst, tensorSecond):
	...
	tensorPreprocessedFirst = tensorFirst.view(1, 3, intHeight, intWidth) #cuda()
	tensorPreprocessedSecond = tensorSecond.view(1, 3, intHeight, intWidth) #cuda().
